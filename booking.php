    ...
    <?php
        ...
        if(isset($_POST['phonenum'])) {
            ...
            while($rowB=mysqli_fetch_assoc($c)) {
                ...
                goto2("index.php", "Your booking has been received! We will contact you soon! :)");
            }
        } else {
    ...
    <section class="inner-page">
      ...
      <form action="booking.php" method="POST">
          ...
          <div class="form-group">
              ...
              <input type="email" class="form-control" id="email" name="email" value="<?php echo $email; ?>"><br><br>
          </div>
