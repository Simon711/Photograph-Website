...
<head>
  ...
  <title>Booking Page | ZHAZHA</title>
    ...
    <section class="inner-page">
      ...
      <table>
          ...
          <?php
            ...
            $sql ="select * from tblbooking LIMIT $start_from, $per_page_record";  // sql command
          ...
          <tr>
            ...
            <td><p><a href="updatebooking.php?bookingID=<?php echo  $row['bookingID'] ; ?>">Update </a> </p></td>
            <td><p><a href="deletebooking.php?bookingID=<?php echo  $row['bookingID'] ; ?>" onclick="return confirm('DO YOU CONFIRM TO DELETE? Y/N')">Delete </a> </p></td>
          </tr>
          <?php $no++; } ?>
        </table>
        <br>
        <a href="insertbooking.php"><input type='submit' name='submit' value='Insert Booking' style="width:180px" class="button" ></a>
        ...
        <?php  
              ...
              if($page>=2){   
                  echo "<a href='viewbooking.php?page=".($page-1)."'>  Prev </a>";   
              }       
                        
              for ($i=1; $i<=$total_pages; $i++) {   
                if ($i == $page) {   
                    $pagLink .= "<a class = 'active' href='viewbooking.php?page="  
                                                      .$i."'>".$i." </a>";   
                }               
                else  {   
                    $pagLink .= "<a href='viewbooking.php?page=".$i."'>   
                                                      ".$i." </a>";     
                }   
              };     
              echo $pagLink;   
              ...
              if($page<$total_pages){   
                  echo "<a href='viewbooking.php?page=".($page+1)."'>  Next </a>";   
              }   
