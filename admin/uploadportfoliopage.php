...
if(isset($_POST['submit'])){
    ...
    $photolink = './assets/img/portfolio/'.$filename;
	// Check extension
	if( in_array($imageFileType,$extensions_arr) ){
 
	// Upload files and store in database
	if(move_uploaded_file($_FILES["image"]["tmp_name"],'../assets/img/portfolio/'.$filename)){
		// Image db insert sql
		$insert = "INSERT into `finalproject`.`tblphoto`(`photoid`,`photoname`,`photodes`,`photolink`,`categoryID`) values('".$photoid."','$photoname','$photodes','$photolink','$catID')";
		if(mysqli_query($conn, $insert)){
            goto2("admin.php"," Photo is successfully inserted");
		}
		else{
...
<head>
  ...
  <title>Upload Image | ZHAZHA</title>
...
<body>
  ...
  <main id="main" data-aos="fade-up">
    ...
    <colgroup>
      ...
      <tr>
        <td><label for="Photo ID">Photo ID:</label> </td>
        <td><input type="text" id="photoid" name="photoid" style="width:200px"></td>
      </tr>
      <tr>
      <td><label for="Photo Name">Photo Name:</label></td>
      <td><input type="text" id="photoname" name="photoname" style="width:500px"></td>
      </tr>
      <tr>
      <td><label for="Description"> Photo Description:</label></td>
      <!--<td><input type="text" id="photodes" name="photodes" style="width:500px"></td>-->
      <td><textarea id="photodes" name="photodes" rows="4" cols="59"></textarea></td>
      </tr>
      <tr>
      <td><label for="Category ID"> Category Name:</label></td>
      <td><select  id="categoryID" name="categoryID" style="width:200px">
