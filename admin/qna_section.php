    ...
    <div class="container" data-aos="fade-up">
      ...
      <br>
      <a href="updateFAQtitle.php?faqID=1" title="Edit Title"> <i style="font-size: 25px">Edit Title </i><i  class="bi bi-pen" style="font-size: 25px"></i></a>
      ...
      <p><a href="qna_edit.php" title="Edit FAQ"><b style="font-size: 50px">+</b></a></p>
