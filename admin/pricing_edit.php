  ...
  <main id="main" data-aos="fade-up">
    ...
    <?php
        ...
        if(isset($_POST['ptag'])) {
            ...
            $sql ="UPDATE `pricing_h` SET `tag`='".$ptag."' , `title1`='".$ptitle1."' , `title2`='".$ptitle2."' , `description`='".$desc."' WHERE (`tagID`='".$tagid."')";  // sql command
            mysqli_select_db($conn,"finalproject"); ///select database as default
            $result=mysqli_query($conn,$sql);  // command allow sql cmd to be sent to mysql
            goto2("admin.php", "Pricing header successfully updated");

        } else {

            $tagid=$_GET['tagID'];
           
            $sql ="select * from `pricing_h` WHERE `tagID`='".$tagid."'";
            mysqli_select_db($conn, "finalproject");//select database as default
    ...
    <section class="inner-page">
      <div class="container">
      <form action="pricing_edit.php?tagID=<?php echo $tagid; ?>" method="POST">
        <div class="form-group">
          <label for="Pricing Tag">Pricing Tag:</label>
          <input type="text" class="form-control" id="ptag" name="ptag" value="<?php echo $row['tag']; ?>"><br><br>
        </div>
        <div class="form-group">
          <label for="Pricing Title 1">Pricing Title 1:</label>
          <input type="text" class="form-control" id="ptitle1" name="ptitle1" value="<?php echo $row['title1']; ?>"><br><br>
        </div>
        <div class="form-group">
          <label for="Pricing Title 2">Pricing Title 2:</label>
