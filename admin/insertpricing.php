...
<head>
  ...
  <title>Insert Pricing | ZHAZHA</title>
  ...
  <main id="main" data-aos="fade-up">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Insert Pricing</h2>
          <ol>
            <li><a href="admin.php">Home</a></li>
            <li>Insert Pricing</li>
          </ol>
        </div>
    ...
    <?php
        ...
        if(isset($_POST['packageid'])) {
            ...
            $sql ="INSERT INTO `tblpricing` (`packageID`, `packageName`, `firstLine`, `secondLine`, `thirdLine`, `fourthLine`, `fifthLine`, `price`) 
            VALUES ('".$packageid."', '".$packagename."', '".$desc1."', '".$desc2."', '".$desc3."', '".$desc4."', '".$desc5."', '".$price."')";  // sql command
            mysqli_select_db($conn,"finalproject"); ///select database as default
            $result=mysqli_query($conn,$sql);  // command allow sql cmd to be sent to mysql
            //$row=mysqli_fetch_assoc($result); 
            goto2("admin.php", "Pricing is successfully inserted");
    ...
    <section class="inner-page">
      ...
      <form action="insertpricing.php" method="POST">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="packageid" name="packageid" required><br><br>
        </div>
        <div class="form-group">
          <label for="Package Name">Package Name:</label>
          <input type="text" class="form-control" id="packagename" name="packagename"><br><br>
        </div>
        <div class="form-group">
          <label for="Description 1">Description 1:</label>
          <input type="text" class="form-control" id="desc1" name="desc1"><br><br>
        </div>
        <div class="form-group">
          <label for="Description 2">Description 2:</label>
          <input type="text" class="form-control" id="desc2" name="desc2"><br><br>
        </div>
        <div class="form-group">
          <label for="Description 3">Description 3:</label>
          <input type="text" class="form-control" id="desc3" name="desc3"><br><br>
        </div>
        <div class="form-group">
          <label for="Description 4">Description 4:</label>
          <input type="text" class="form-control" id="desc4" name="desc4"><br><br>
        </div>
        <div class="form-group">
          <label for="Description 5">Description 5:</label>
          <input type="text" class="form-control" id="desc5" name="desc5"><br><br>
        </div>
        <div class="form-group">
