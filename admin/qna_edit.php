  ...
  <main id="main" data-aos="fade-up">
    ...
    <section class="inner-page">
      ...
      <tr>
        ...
        <th width="40%" scope="col">ANSWER</th>
        <th width="15%" scope="col">ACTION</th>
      </tr>

      <?php 
        $sql = "SELECT * FROM `finalproject`.`qna` ORDER BY question";
      ...
      ?>
        <tr>
          ...
          <td><a href="qna_update.php?id=<?php echo $row['id'];?>">Update</a>    &nbsp &nbsp &nbsp 
        <a href="qna_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('DO YOU CONFIRM TO DELETE? Y/N')">Delete</a></td>
        </tr>
      ...
      <a href="qna_add.php"><input type='submit' name='Submit' value='Add New FAQ' style="width:180px" class="button" ></a> 
      &nbsp
      <div class="backmain">
