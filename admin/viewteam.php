    ...
    <section class="inner-page">
      <div class="container">
        <table>
          ...
          <?php
            $no=1;
            $sql ="select * from team_member";  // sql command
          ...
          <tr>
            ...
            <td><img src=<?php echo ".".$row["ProfilePic"]; ?> width="100px" height="100px" alt="Profile pic"></td>
            <td><p><a href="updateteam.php?MatricNo=<?php echo  $row['MatricNo'] ; ?>">Update </a> </p></td>
            <td><p><a href="deleteteam.php?MatricNo=<?php echo  $row['MatricNo'] ; ?> " onclick="return confirm('DO YOU CONFIRM TO DELETE? Y/N')">Delete </a> </p></td>
          </tr>
          <?php $no++;
        } ?>
        </table>
<br>
        ...
        <a href="insertteam.php"><input type="button" class="button" style="width:180px " value="Insert New Member"></a> 
        <div class="backmain">
        <a href="admin.php#team"><input type="button" class="button" style="width:100px " value="Back"></a>
        </div>
